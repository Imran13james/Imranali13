        ...
        {tech.map((item, i) => (
          <div
            ...
            className={cn(
              ...
              item === 'Tailwind Just started' && 'border border-blue-500/60',
              item === 'Javascript' && 'border border-yellow-500/60',
              item === 'React Js' && 'border border-blue-500/60',
              item === 'Next Js 13 Just started' && 'border border-white/60',
              ...
              item === 'Typescript Just started' && 'border border-blue-500/60',
